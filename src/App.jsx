  ...
  return (
    ...
    <Menu></Menu>
      <Routes>
        ...
        <Route exact path='/administrador' element={<Administrador></Administrador>}/>
        <Route exact path='/administrador/crearProducto' element={<CrearProducto></CrearProducto>}/>
        <Route exact path='/administrador/editarProducto' element={<EditarProducto></EditarProducto>}/>
        <Route exact path='/detalleProducto' element={<DettalleProducto></DettalleProducto>}/>
